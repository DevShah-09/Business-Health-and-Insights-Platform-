...
const badgeVariants = {
  ...
  default:'bg-[#2d3449] text-slate-300 border border-[#464554]/30',
};
    ...
    <div className="flex flex-col gap-1.5">
      {(label || showValue) && (
        <div className="flex justify-between text-xs">
          ...
          {showValue && <span className="font-semibold text-slate-200">{pct}%</span>}
        </div>
      )}
      <div className="h-2 w-full overflow-hidden rounded-full bg-[#2d3449]">
        <div
